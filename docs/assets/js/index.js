(function () {
  ...
  var ENDPOINT = 'http://n8-vm1.eastus.cloudapp.azure.com:90/api/status/1/customers';
  ...
  ContactForm.prototype.onSubmit = function onSubmit (event) {
  ...
  ContactForm.prototype.isValidEmail = function isValidEmail (str) {
  	// TODO add proper email validation regex
  	return str.length > 5
  };
  	

  ContactForm.prototype.submitAjaxForm = function submitAjaxForm () {
  ...
  ContactForm.prototype.hideElement = function hideElement (el) {
  	el.style.display = 'none';
  };
  	
  ContactForm.prototype.showElement = function showElement (el) {
  	el.style.display = 'block';
  };

  ContactForm.prototype.getFormJson = function getFormJson () {
  	return {
      ...
      ContactForm.prototype.log = function log () {
